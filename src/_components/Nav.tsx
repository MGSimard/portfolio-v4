  ...
  return (
    <header className="select-none py-4">
      <nav className="flex justify-center items-center gap-8 md:gap-16 text-lg font-medium">
        ...
        <Link
          to="/webdev"
          className="[view-transition-name:nav-webdev] group hover:text-primary focus-visible:text-primary outline-none text-nowrap shrink-0"
        ...
        <Link
          to="/gamedev"
          className="[view-transition-name:nav-gamedev] group hover:text-primary focus-visible:text-primary outline-none text-nowrap shrink-0"
          activeProps={{ className: "text-secondary" }}
          inactiveProps={{ className: "text-primary/50" }}
