...
export function Nav() {
  return (
    <header className="select-none py-4">
      <nav className="flex justify-center items-center gap-16 text-lg font-medium">
        <Link to="/" className="font-medium [view-transition-name:nav-home]" aria-label="Home" viewTransition>
          <span aria-hidden>MGSIMARD</span>
        </Link>
        <Link
          to="/webdev"
          className="[view-transition-name:nav-webdev] group hover:text-primary focus-visible:text-primary outline-none"
        ...
        <Link
          to="/gamedev"
          className="[view-transition-name:nav-gamedev] group hover:text-primary focus-visible:text-primary outline-none"
          activeProps={{ className: "text-secondary" }}
          inactiveProps={{ className: "text-primary/50" }}
